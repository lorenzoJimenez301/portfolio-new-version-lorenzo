...
export const Navbar = () => {
  ...
  return (
    <nav className=" w-full bg-lorenzo-gray px-5 py-4 lg:px-12 lg:flex items-center justify-between min-w-sm fixed z-100">
        ...
        <AnimatePresence>
          {isOpen && (
            <motion.ul
              ...
              className="uppercase absolute top-[6.5rem] flex lg:hidden flex-col lg:flex-row lg:items-center gap-8 lg:gap-10 w-full z-50 px-8 py-10 md:p-10 bg-lorenzo-gray shadow-lg"
            >
              <li className="h-max">
